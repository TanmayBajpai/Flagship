...
function CreateBox({ setOverlay, setBox, setChanged }) {

    const [selected, setSelected] = useState([])
    const [info, setInfo] = useState("Selecting no countries will allow all countries.")
        ...
        <>
            <div className="box">
                ...
                <form className="update-form">
                    ...
                    <input type="text" className="update-form-input" id="flagName" placeholder="Name" onChange={() => { setInfo("") }}>
                    </input>

                    <label className="update-form-label">
                        Flag Description
                    </label>
                    <input type="text" className="update-form-input" id="description" placeholder="Description">
                    </input>

                    <label className="update-form-label">
                        Rollout Percent
                    </label>
                    <input type="number" className="update-form-input" id="rolloutPercent" min="0" max="100" placeholder="Rollout %" onChange={() => { setInfo("") }}>
                    </input>
                    ...
                    <div className="buttons">
                        ...
                        <button className="submit-button" type="button" onClick={() => createFlag()}>Submit</button>
                    </div>
                </form>
            </div>
        </>
